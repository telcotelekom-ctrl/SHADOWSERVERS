...
async function matchTracksByKey({ keyName, query, limit, credentials }) {
  if (!isConfigured(credentials)) {
    return {
      configured: false,
      message: 'Spotify ist für dieses Konto noch nicht konfiguriert. Trage deine Spotify Client-ID und Client-Secret im Einrichtungsformular ein.'
    };
  }
